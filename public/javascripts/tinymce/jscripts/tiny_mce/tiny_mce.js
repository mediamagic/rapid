...
tinymce.dom = {}; (function(b, h) {
    ...
    function d(m, n, l) {
        ...
        if (g) {
            ...
            if (k.documentElement.doScroll && m === m.top) { (function() {
                    try {
...
tinymce.dom.TreeWalker = function(a, c) {
    ...
    e.create("tinymce.dom.DOMUtils", {
        ...
        fixDoc: function(k) {
            var j = this.settings,
            i;
            if (b && j.schema) { ("abbr article aside audio canvas details figcaption figure footer header hgroup mark menu meter nav output progress section summary time video").replace(/\w+/g, function(l) {
                    k.createElement(l)
                    });
