...
Swiper = function(selector, params, callback) {
	...
	function dQ(s) {
		return $(thisElm.container).children(s)
	}
	var _this = this
	_this.touches = {};
	_this.positions = {
	...
	_this.updatePagination = function() {
		...
		for (var i = minPagerIndex; i <= maxPagerIndex; i++ ) {
			...
			if (j<0) j = pagers + j;
			if (j<numOfSlides) {
				dQ(params.pagination+' .'+params.paginationClass).attr('class','').addClass(params.paginationClass+' '+params.paginationActiveClass);
			}
	...
	_this.createPagination = function () {
	  	if (params.pagination && params.createPagination) {
			...
			$(thisElm.container).children(params.pagination).append($(paginationHTML))
			_this.updatePagination()
