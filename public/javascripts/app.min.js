...
var GlobalCtrl=["$scope","$resource","$location","$window","$cookies","$http",function(a,b,c,d,e,f){a.Settings=b("/resources/settings");a.location=c;a.resource=b;a.Settings.get({},function(b){a.settings=b;a.Login=a.resource("/api/login",{_csrf:e["csrf.token"]});a.$broadcast("settings_loaded");b=a.settings.defaultCategory;a.filters={category:void 0!=a.settings.categories[b]?b:"all"}});a.form={firstname:"",lastname:"",phone:"",email:"",type:"private"};a.formReset=angular.copy(a.form);a.formSubmit=function(b){if(b.leadForm.$invalid)return b.leadForm.$setDirty();
