...
d.getSortData[c]=createOrderFn(c);setTimeout(function(){b.isotope(d).isotope("reloadItems").isotope({sortBy:"all"})},100);a.$watch("articles",function(a,c){a!=c&&b.isotope("reloadItems")});a.$watch("filters.category",function(a){b.isotope({sortBy:a})})}}}).directive("isoItem",function(){return{priority:0,restrict:"A",link:function(a,b){var c=a.articles[a.$index],d=b.children(".preview");createPreview(d,c)}}});
function createOrderFn(a){return function(b){b=$(b).attr("rel");b=JSON.parse(b);return parseInt(b[a])}}function createPreview(a,b){var c=createContent(b),d="";switch(b.preview.type){case "flash":break;case "iframe":break;case "image":break;default:d=b.preview.content}a.html(d).css("background",b.bgColor).bind("click",function(){$(".close").click();a.hide().parent().append(c.show()).parent().isotope("reLayout")})}
function createContent(a){var b=$('<div class="content"><div class="close">X</div></div>');a=a.content;var c="";switch(a.type){case "flash":break;case "iframe":break;case "image":break;default:c=a.content}b.append(c).css("background",a.bgColor).show().children(".close").bind("click",function(){b.hide().siblings(".preview").show();b.parent().parent().isotope("reLayout")});return b};angular.module("rapid.controllers",["ngResource","ngCookies","ui"]);
